...
def print_config_info(arguments: dict, dataset: base_dataset.Dataset, task: str):
    ...
    print('Dataset: ' + arguments["dataset_name"])
    ...
    print('- No. of samples: ' + str(dataset.X_full.shape[0]))
    if dataset.featureset == 'features':
        print('- No. of features: ' + str(dataset.X_full.shape[1]))
    else:
        print('- Featureset: ' + dataset.featureset)
