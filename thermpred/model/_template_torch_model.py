...
class TemplateTorchModel(_torch_model.TorchModel):
    """
    Template file for a prediction model based on :obj:`~thermpred.model._torch_model.TorchModel`
    ...
    **Steps you have to do to add your own model:**
        ...
        2. Rename the class and add it to *thermpred.model.__init__.py*
        ...
        5. Define the hyperparameters and ranges you want to use for optimization in *define_hyperparams_to_tune()*.
           ...
           CAUTION: Some hyperparameters are already defined in :obj:`~thermpred.model._torch_model.TorchModel.common_hyperparams()`,
           which you can directly use here. Some of them are already suggested in :obj:`~thermpred.model._torch_model.TorchModel`.
    ...
    def define_hyperparams_to_tune(self) -> dict:
        ...
        See :obj:`~thermpred.model._base_model.BaseModel` for more information on the format and options.

        Check :obj:`~thermpred.model._torch_model.TorchModel` for already defined (and for some cases also suggested) hyperparameters.
        """
        return {
            'example_param_1': {
